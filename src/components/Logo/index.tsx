...
const Logo = ({ color = 'white', size = 'normal' }: LogoProps) => (
  <S.Wrapper color={color} size={size}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 158 48" role="img" aria-label="Won Games">
      ...
      />
      <path fill="#110F28" fillOpacity=".15" d="M30.16 27.16l-6.03-4.3a.5.5 0 00-.78.5l1.3 7.3 5.51-3.5z" />
      <path
        stroke="#fff"
        strokeLinecap="round"
        strokeOpacity=".4"
      ...
      />
      <path stroke="#0A0D27" strokeLinecap="round" strokeWidth="2" d="M13.05 15.1v6M10.04 18.1h6.02" />
      ...
      />
      <defs>
        <linearGradient id="paint0_linear" x1="29.16" x2="30.15" y1="-7.4" y2="49.1" gradientUnits="userSpaceOnUse">
